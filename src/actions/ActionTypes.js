...
export const PROFILE_OTHER_GET = "PROFILE_OTHER_GET";
export const PROFILE_OTHER_GET_SUCCESS = "PROFILE_OTHER_GET_SUCCESS";
export const PROFILE_OTHER_GET_FAILURE = "PROFILE_OTHER_GET_FAILURE";
